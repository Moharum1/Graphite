...
impl ShapeState {
	...
	/// Find a [ManipulatorPoint] that is within the selection threshold and return the layer path, an index to the [ManipulatorGroup](crate::bezier_rs::ManipulatorGroup), and an enum index for  [ManipulatorPoint].
